...
public class SimplePicture implements DigitalPicture
{
 ...
 /**
   ...
   */
  public Picture_WillRawlings scale(double xFactor, double yFactor)
  {
    ...
    Picture_WillRawlings result = new Picture_WillRawlings((int) (getWidth() * xFactor),
   ...
   * @return the resulting picture
   */
  public Picture_WillRawlings getPictureWithWidth(int width)
  {
    // set up the scale transform
    double xFactor = (double) width / this.getWidth();
    Picture_WillRawlings result = scale(xFactor,xFactor);
    return result;
  }
   ...
   * @return the resulting picture
   */
  public Picture_WillRawlings getPictureWithHeight(int height)
  {
    // set up the scale transform
    double yFactor = (double) height / this.getHeight();
    Picture_WillRawlings result = scale(yFactor,yFactor);
    return result;
  }
